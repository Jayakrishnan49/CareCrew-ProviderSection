...
class ServiceProvider extends ChangeNotifier {
  ...
  try {
    ...
    if (_identityImagePath != null && _identityImagePath!.isNotEmpty) {
      uploadedIdCardUrl =
          await uploadImageToCloudinary(_identityImagePath!);
    }

    // Upload experience certificate
    if (_experienceCertificatePath != null &&
        _experienceCertificatePath!.isNotEmpty) {
      uploadedExperienceCertUrl =
          await uploadImageToCloudinary(_experienceCertificatePath!);
    }
    ...
    final updatedUser = user.copyWith(
      ...
      experienceCertificate:
          uploadedExperienceCertUrl ?? user.experienceCertificate,
    );
