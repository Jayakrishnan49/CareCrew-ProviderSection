  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
         SingleChildScrollView(
          ...
          child: SafeArea(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: context.watch<ServiceProvider>().isLoading
                              ? null
                              :() async {
            ...
            // showDialog(
            //   context: context,
            //   barrierDismissible: false, // Prevents user from canceling while uploading
            //   builder: (context) => CustomShowDialog(
            //     title: 'Uploading...',
            //     subTitle: 'Please wait while we secure your documents.',
            //     animationPath: 'assets/animations/Uploading.json.json', // Ensure this path exists
            ...
            // );
                          ...
                          //   ),
                          // );
                          // CustomShowDialog(title: 'Uploading documents', subTitle: 'subTitle', onTap: (){},
        ...
        if (context.watch<ServiceProvider>().isLoading)
  Container(
